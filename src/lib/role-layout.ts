...
export const STAFF_RIGHT_MARGIN = 24;
export const STAFF_TOTAL_INDENT = STAFF_LEFT_OFFSET + STAFF_RIGHT_MARGIN; // 60
export const STAFF_LINE_SPACE = STAFF_TOTAL_INDENT;
