...
import { MIN_ROLE_WIDTH, STAFF_LINE_SPACE } from '../lib/role-layout';
...
const role = (
  ...
  x,
  y,
  width: kind === 'staff' ? Math.min(width, MIN_ROLE_WIDTH - STAFF_LINE_SPACE) : Math.max(MIN_ROLE_WIDTH, width),
  height,
  lines,
  fontSize,
  order,
